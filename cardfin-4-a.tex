...
% https://www.site24x7.com/tools/time-stamp-converter.html 1773524910
\documentclass[12pt,letterpaper]{article}
\usepackage{fancyhdr}
\fancyhf{}
\fancyfoot[R]{{\tiny cardfin-4-a,\ \filemodprintdate{\jobname},\ \filemodprinttime{\jobname},\ 1773524910}} % https://www.site24x7.com/tools/time-stamp-converter.html (https://www.unixtimestamp.com/ bad)
...
\begin{proof}
We assume $m\le n$ (as we may, by symmetry of $\simeq$) and apply Lemma \ref{L3}, (a) $\Rightarrow$ (c), with $k=m,Z=[n]$ and $c_i=i$ for $i=1, \ldots, m$. 
\end{proof} 
