...
% https://www.site24x7.com/tools/time-stamp-converter.html 1768228590
\documentclass[12pt,letterpaper]{article}
\usepackage{fancyhdr}
\fancyhf{}
\fancyfoot[R]{{\tiny cardfin-4-a,\ \filemodprintdate{\jobname},\ \filemodprinttime{\jobname},\ 1768228590}} % https://www.site24x7.com/tools/time-stamp-converter.html (https://www.unixtimestamp.com/ bad)
...
\begin{proof} 
Assume by contradiction that $f$ \emph{is} surjective. We can suppose $X=[n]$. Set 
$$
Z:=\{\min f^{-1}(f(i))\ |\ i\in X\}\subset X.
$$ 
Then $f$ induces a bijection $Z\overset{\sim}{\to}Y$ and Theorem~\ref{T5} implies $|X|<|Y|=|Z|\le|X|$, contradiction. 
\end{proof} 
