...
% https://docs.google.com/document/d/16Y-P04BX4PC3ns8JG9o8K1J7vIxfMnJ3ncR5v0kPaH4/edit?tab=t.0
% !TEX encoding = UTF-8 Unicode
% https://www.site24x7.com/tools/time-stamp-converter.html 1773618044
\documentclass[12pt,letterpaper]{article}
\usepackage{fancyhdr}
\fancyhf{}
\fancyfoot[R]{{\tiny cardfin-4-a,\ \filemodprintdate{\jobname},\ \filemodprinttime{\jobname},\ 1773618044}} % https://www.site24x7.com/tools/time-stamp-converter.html (https://www.unixtimestamp.com/ bad)
...
\begin{proof}
Use Lemma \ref{L2}, (a) $\Rightarrow$ (c), with $X=[k],Y=Z$ and $a_i=i,b_i=c_i$ for $i=1,\ldots,k$. 
\end{proof}
...
\begin{proof}
We assume $m\le n$ (as we may, by symmetry of $\simeq$) and apply Lemma \ref{L3}, with $k=m,Z=[n]$ and $c_i=i$ for $i=1, \ldots, m$. 
\end{proof} 
...
For completeness' sake we add the ``Co-Pigeonhole Principle'': 

\begin{prop}[``Co-Pigeonhole Principle'']%\label{P7}
If $X$ and $Y$ are finite set, if $|X|<|Y|$, and if $f:X\to Y$ is a map, then $f$ is \emph{not} surjective. 
\end{prop} 

\begin{proof} 
Assume by contradiction that $f$ \emph{is} surjective. We can suppose $X=[n]$. Define $g:Y\to X$ by $g(y)=\min f^{-1}(y)$.  Then $g$ is injective and Theorem~\ref{T5} implies $|X|<|Y|=|g(Y)|\le|X|$, contradiction. 
\end{proof} 
