...
% https://www.site24x7.com/tools/time-stamp-converter.html 1767095642
\documentclass[12pt,letterpaper]{article}
\usepackage{fancyhdr}
\fancyhf{}
\fancyfoot[R]{{\tiny cardfin-c,\ \filemodprintdate{\jobname},\ \filemodprinttime{\jobname},\ 1767095642}} % https://www.site24x7.com/tools/time-stamp-converter.html (https://www.unixtimestamp.com/ bad)
...
\end{cases}
$$ 
Then $[X,a,b]$ is its own inverse; in particular it is bijective. 

\begin{lem}\label{La}
If $X$ and $Y$ are sets such that $X\simeq Y$, and if $a\in X$ and $b\in Y$, then there is a bijection $X\to Y$ mapping $a$ to $b$.  
\end{lem} 
...
\begin{lem}\label{Lb}
If $X$ and $Y$ are sets such that $X\simeq Y$, and if $a\in X$ and $b\in Y$, then we have $X\setminus\{a\}\simeq Y\setminus\{b\}$.  
\end{lem} 
