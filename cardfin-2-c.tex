...
% https://www.site24x7.com/tools/time-stamp-converter.html 1768054661
\documentclass[12pt,letterpaper]{article}
\usepackage{fancyhdr}
\fancyhf{}
\fancyfoot[R]{{\tiny cardfin-2-c,\ \filemodprintdate{\jobname},\ \filemodprinttime{\jobname},\ 1768054661}} % https://www.site24x7.com/tools/time-stamp-converter.html (https://www.unixtimestamp.com/ bad)
...
\begin{proof}
We assume $m\le n$ (as we may, by symmetry $\simeq$) and apply Lemma \ref{L}, (a) $\Rightarrow$ (c), with $X=[m],Y=[n],k=m$ and $a_i=b_i=i$ for $i=1,\ldots, m$. 
\end{proof} 
