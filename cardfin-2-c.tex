...
% https://www.site24x7.com/tools/time-stamp-converter.html 1767637544
\documentclass[12pt,letterpaper]{article}
\usepackage{fancyhdr}
\fancyhf{}
\fancyfoot[R]{{\tiny cardfin-2-c,\ \filemodprintdate{\jobname},\ \filemodprinttime{\jobname},\ 1767637544}} % https://www.site24x7.com/tools/time-stamp-converter.html (https://www.unixtimestamp.com/ bad)
...
\usepackage[letterpaper,top=60pt,left=60pt,right=60pt,bottom=120pt]{geometry}
...
\begin{proof}
We assume $0<m\le n$ (as we may) and apply Lemma \ref{L}, (a) $\Rightarrow$ (c), with $X=[m],Y=[n],k=m$ and $a_i=b_i=i$ for $i=1,\ldots, m$. 
\end{proof} 
